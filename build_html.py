...
<body>
    ...
    <script>
        ...
        const positionMetrics = {{
            qb:     ['GP', 'C', 'Att', 'Yds', 'C%', 'Avg', 'Y/G', 'C/G', 'TD', 'TD/G', 'Int', 'Lng', 'QBR',
                     'Rush_GP', 'Rush_Car', 'Rush_Yds', 'Rush_Avg', 'Rush_Y/G', 'Rush_Lng', '100+', 'Rush_TD'],
            rb:     ['GP', 'Rush_Car', 'Rush_Yds', 'Rush_Avg', 'Rush_Y/G', 'Rush_Lng', 'Rush_100+', 'Rush_TD',
                     'Rec_GP', 'Rec_Rec', 'Rec_Yds', 'Rec_Avg', 'Rec_Y/G', 'Rec_Lng', 'Rec_TD'],
            wr:     ['GP', 'Rec_Rec', 'Rec_Yds', 'Rec_Avg', 'Rec_Y/G', 'Rec_Lng', 'Rec_TD',
                     'Rush_GP', 'Rush_Car', 'Rush_Yds', 'Rush_Avg', 'Rush_Y/G', 'Rush_Lng', '100+', 'Rush_TD'],
            te:     ['GP', 'Rec_Rec', 'Rec_Yds', 'Rec_Avg', 'Rec_Y/G', 'Rec_Lng', 'Rec_TD',
                     'Rush_GP', 'Rush_Car', 'Rush_Yds', 'Rush_Avg', 'Rush_Y/G', 'Rush_Lng', '100+', 'Rush_TD'],
            safety: ['GP', 'SOLO', 'ASST', 'TKLS', 'T/G', 'TFL', 'INT', 'PD'],
            cb:     ['GP', 'SOLO', 'ASST', 'TKLS', 'T/G', 'TFL', 'INT', 'PD'],
            lb:     ['GP', 'SOLO', 'ASST', 'TKLS', 'T/G', 'TFL', 'GP_2', 'SACKS', 'YDL', 'S/G', 'HURS'],
            de:     ['GP', 'SOLO', 'ASST', 'TKLS', 'T/G', 'TFL', 'GP_2', 'SACKS', 'YDL', 'S/G', 'HURS'],
            dt:     ['GP', 'SOLO', 'ASST', 'TKLS', 'T/G', 'TFL', 'GP_2', 'SACKS', 'YDL', 'S/G', 'HURS'],
        }};
